...
const additionalFeatures = [
  {
    name: 'Aprendizado Adaptativo com UI Interativa',
    description:
      'Nossa IA analisa o perfil de cada aluno e gera componentes UI interativos personalizados, criando uma experiência de aprendizado única e envolvente que se adapta às necessidades individuais.',
    icon: BookOpen,
  },
  {
    name: 'Aprendizagem Colaborativa',
    description:
      'Crie grupos de estudo virtuais e incentive a troca de conhecimentos entre os alunos, mesmo à distância.',
    icon: Users,
  },
  {
  ...
  {
    name: 'Uma Nova Forma de Aprender',
    description:
      'Revolucione a educação com nossa abordagem inovadora que combina tecnologia de ponta, metodologias pedagógicas avançadas e experiências de aprendizado imersivas.',
    icon: Lightbulb,
  },
];
              ...
              <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                <div className="flex items-center justify-between">
                  <Link href="/" className="-m-1.5 p-1.5 flex items-center">
                    ...
                    />
                    <span className="text-xl font-bold text-blue-600">Me ensina aí</span>
                  </Link>
                  <button
                    type="button"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Tudo que você precisa para revolucionar o aprendizado
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Nossa plataforma combina tecnologia de ponta com métodos pedagógicos comprovados para criar uma experiência de aprendizagem única e eficaz. Descubra como podemos transformar a educação na sua instituição.
            </p>
          </div>
